# Careers Job Detail WCAG Checklist Analysis (Strict Pass/Fail)

Source checklist: wcag compliance.md
Scope analyzed: route /careers/[jobId].
...
- Route has a defined page heading with supporting heading structure in audited components: app/careers/[jobId]/page.tsx:200, app/careers/[jobId]/page.tsx:260.

### 1.2 Landmark Regions (WCAG 1.3.1)

- Route exposes shared main landmark target: app/careers/[jobId]/page.tsx:180.
...
- Evidence: wcag compliance/evidence/contrast/careers-jobId-contrast.json (0 failing nodes).
