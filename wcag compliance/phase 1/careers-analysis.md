# Careers WCAG Checklist Analysis (Strict Pass/Fail)

Source checklist: wcag compliance.md
Scope analyzed: route /careers.
...
- Route has a defined page heading with supporting heading structure in audited components: components/careers/CareersHeroSection.tsx:125, components/careers/CareersListingsSection.tsx:84.

### 1.2 Landmark Regions (WCAG 1.3.1)

- Route exposes shared main landmark target: app/careers/page.tsx:142.
...
- Evidence: wcag compliance/evidence/contrast/careers-contrast.json (0 failing nodes).
