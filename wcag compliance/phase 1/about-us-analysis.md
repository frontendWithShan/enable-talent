# About Us WCAG Checklist Analysis (Strict Pass/Fail)

Source checklist: wcag compliance.md
Scope analyzed: route /about-us.
...
- Route has a defined page heading with supporting heading structure in audited components: components/about/AboutHeroSection.tsx:26.

### 1.2 Landmark Regions (WCAG 1.3.1)

- Route exposes shared main landmark target: app/about-us/page.tsx:29.
...
- Evidence: wcag compliance/evidence/contrast/about-us-contrast.json (0 failing nodes).
