...
type InquiryType = "general" | "partnership" | "support" | "media" | "careers" | "feedback";
...
export default function ContactUsModal({
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    if (!subject) nextFieldErrors.subject = "Subject is required.";
    ...
    if (Object.keys(nextFieldErrors).length > 0) {
      ...
      const firstInvalid: FieldName[] = ["fullName", "email", "subject", "message", "phone"];
    ...
    try {
      const { submitContactForm } = await import("@/utils/inquiriesClient");
      ...
      {isOpen && (
        ...
        >
          ...
          >
            ...
            <div className="pr-10">
              <h2 id="contact-us-title" className="text-2xl font-extrabold tracking-tight text-slate-900">
                {title}
              </h2>
              <p id="contact-us-description" className="mt-2 text-sm leading-relaxed text-slate-600">
            ...
            <form onSubmit={handleSubmit} className="mt-6 space-y-4" autoComplete="on" noValidate>
              <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                <div>
                  ...
                  <input
                    ...
                    className="w-full rounded-xl border border-slate-300 bg-white px-3 py-2 text-slate-900 shadow-sm transition focus-visible:border-[#0D3541] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#0D3541] focus-visible:ring-offset-2"
                    placeholder="Jane Doe"
                  />
                  {fieldErrors.fullName ? (
                    <p id="contact-fullName-error" className="mt-1 text-xs font-medium text-red-700">
                      {fieldErrors.fullName}
                    </p>
                  ) : null}
                </div>
                ...
                <div>
                  ...
                  />
                  {fieldErrors.email ? (
                    <p id="contact-email-error" className="mt-1 text-xs font-medium text-red-700">
                      {fieldErrors.email}
                    </p>
                  ) : null}
                </div>
              ...
              <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                ...
                <div>
                  ...
                  />
                  {fieldErrors.phone ? (
                    <p id="contact-phone-error" className="mt-1 text-xs font-medium text-red-700">
                      {fieldErrors.phone}
                    </p>
                  ) : null}
                </div>
              ...
              <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                ...
                <div>
                  ...
                  />
                  {fieldErrors.subject ? (
                    <p id="contact-subject-error" className="mt-1 text-xs font-medium text-red-700">
                      {fieldErrors.subject}
                    </p>
                  ) : null}
                </div>
              ...
              <div>
                ...
                />
                {fieldErrors.message ? (
                  <p id="contact-message-error" className="mt-1 text-xs font-medium text-red-700">
                    {fieldErrors.message}
                  </p>
                ) : null}
              </div>
              ...
              {status === "success" ? (
                ...
                >
                  Thanks, your message has been submitted. We will reach out soon.
                </div>
              ) : null}
